...
//       <th style={{ width: "100px" }}>Chef</th>
//       <th style={{ width: "100px" }}>Sales</th>
//       <th style={{ width: "100px" }}>Zomato</th>
//       <th style={{ width: "90px" }}>Remaining</th>
//       {isAdmin && <th style={{ width: "70px" }}>Delete</th>}
//     </tr>
//   </thead>
//   <tbody>
//     {products
...
//               <button onClick={() => updateValue(p._id, "zomato", 1)}>+</button>
//             </td>
//             <td style={{ textAlign: "center" }}><b>{remaining}</b></td>
//             {isAdmin && (
//               <td style={{ textAlign: "center" }}>
//                 <button
                      ...
                      .map(p => {
                        ...
                        return (
                          <tr key={p._id} style={{ borderBottom: "1px solid #f3f4f6", background: bgColor }}>
                            ...
                            <td style={{ padding: "10px", textAlign: "center", fontWeight: "600", color: "#6b7280" }}>{p.stock}</td>
